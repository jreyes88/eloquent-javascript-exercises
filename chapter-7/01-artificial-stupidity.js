...
// Vector Object - represents coordinate pairs
function Vector(x, y) {
  this.x = x;
  this.y = y;
};
...
// Critter Object - Is stupid, moves around randomly until it hits something and dies
var directions = {
  "n":  new Vector( 0, -1),
  "ne": new Vector( 1, -1),
  "e":  new Vector( 1,  0),
...
var directionNames = "n nne e se s sw w nw" .split(" ");
